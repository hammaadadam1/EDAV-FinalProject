...
class_data$normalized_loudness <- normalize1(class_data$loudness)
class_data$normalized_pop <- normalize2(class_data$track_popularity)
class_data$normalized_artist_pop <- normalize2(class_data$artist_popularity)
class_data$normalized_tempo <- normalize1(class_data$tempo)
class_data$normalized_instrumentalness <- normalize1(class_data$instrumentalness)
